...
const uint32_t N_MIN_DIM     = 400;
const uint32_t N_MAX_DIM     = 500; //300mb limit -> 100mb per matrix, double is 8 byte -> 13107200 elements -> 3620 Elements
const uint32_t N_POINTS      = 5;
...
int main(int argc, char* argv[])
{
    ...
    for (uint32_t m = 1; m <= NWritten-1 ; m++) {
        ...
        float gflops = 2.*matrixsize*matrixsize*matrixsize/mean/1e9;
